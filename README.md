# Introuduction
  - This project is insprited by Pro.Kevin Smith and has been submitted as personal coursework project for the course CS134 at San Jose State University. While this project never implemented by any Gaming Engine, the game is fully power by OpenFrameWork, which is a open source C++ toolkit. That is to say, you need to install OpenFrameWork in your computer to run this project. Please check the instructions below regarding to the detail about how to run the project.
